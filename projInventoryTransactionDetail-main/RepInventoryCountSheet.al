...
report 50125 "Inventory Count Sheet"
{
    DefaultLayout = RDLC; // Specifies the report layout as RDLC (client report definition)
    RDLCLayout = './Local/Inventory/Reports/InventoryCountSheet.rdlc'; // Path to the RDLC layout file
    ApplicationArea = All; // Makes the report accessible across all application areas
    Caption = 'Inventory Count Sheet'; // The title of the report
        ...
        layout // Define the layout for the request page
        {
            area(content) // Define content area of the request page
            {
                group(Options) // Group the options section
                {
                    ...
                    field(ShowLotNos2; ShowLotNos2) // Field for the As Of Date input
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Show Lot Numbers'; // Caption for the field
                        ToolTip = 'Specifies if you want to show lot numbers.'; // Help text for the user
                        ShowMandatory = false; // Mark this field as mandatory
                    }
                }
            }
        }
    ...
    var // Define global variables used in the report
        ...
        ShowLotNos2: Boolean; // Boolean flag for showing lot numbers
